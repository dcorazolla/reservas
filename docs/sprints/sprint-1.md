# Sprint 1 — MVP (snapshot 2026-02-08)
...
2. Implementar `GET /api/reservations` no backend (mínimo) e testar com frontend local.
...
Estas notas são um snapshot operacional para Sprint 1; mantenha atualizado em `docs/sprints/`.
