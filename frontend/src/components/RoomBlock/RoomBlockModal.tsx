    ...
    <Modal open={open} title={block && block.id ? 'Editar bloqueio de quarto' : 'Criar bloqueio de quarto'} onClose={onClose} closeOnBackdrop={false}>
      <form onSubmit={submit} className="form">
        <div className="room-block-grid">
          ...
          <div className="room-block-two-col">
          ...
          {error ? <div className="room-block-error">{error}</div> : null}

          {conflicts.length > 0 ? (
            <div className="form-group room-block-conflicts">
