...
// Client-side validation schema (keeps UX consistent even without backend)
...
export default function LoginPage() {
  ...
  // Visual-only submit: validate client-side, then show a demo notice.
  function onSubmit(_: FormValues) {
    setSubmitting(true)
    // Simulate a short delay for UX; don't call backend.
    setTimeout(() => {
      setSubmitting(false)
      toast({
        title: t('login.title'),
